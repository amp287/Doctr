    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!errorFree) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(DoctorEditInfo.this);
                    ...
                    Intent intent = new Intent(DoctorEditInfo.this, NewDoctorHome.class);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DoctorEditInfo.this, android.R.layout.simple_spinner_dropdown_item, specializationsList);
